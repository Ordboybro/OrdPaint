"""Pytest-only PySide6 compatibility hooks for menu lifetime handling."""
...
def pytest_configure() -> None:
    ...
    def install_recent_menu(self) -> None:
    ...
    application_window.MainWindow._install_recent_menu = install_recent_menu
    application_window.MainWindow._install_image_resize_actions = install_image_resize_actions
    application_window.MainWindow._install_transform_actions = install_transform_actions
