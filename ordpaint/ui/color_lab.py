...
class ColorLabDock(QDockWidget):
    ...
    def __init__(self, window) -> None:
        ...
        palette_buttons.addWidget(save); palette_buttons.addWidget(clear)
    ...
    def _sync(self, color: QColor) -> None:
        ...
        self.h.setValue(max(0, h)); self.s.setValue(s); self.v.setValue(v)
        hh, ss, ll, _ = color.getHsl()
        self.hsl_h.setValue(max(0, hh)); self.hsl_s.setValue(ss); self.hsl_l.setValue(ll)
